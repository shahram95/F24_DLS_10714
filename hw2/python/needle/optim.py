    ...
    def step(self):
        ...
        for param in self.params:
            if param not in self.m:
                self.m[param] = ndl.init.zeros(*param.shape, dtype=param.dtype, device=param.device)
                self.v[param] = ndl.init.zeros(*param.shape, dtype=param.dtype, device=param.device)
