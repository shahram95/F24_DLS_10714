...
class Corpus(object):
    ...
    def tokenize(self, path, max_lines=None):
        ...
        def process_line(line: str):
            # Process each word in the line and add EOS token
...
def batchify(data, batch_size, device, dtype):
    ...
    # Truncate data to fit complete batches and reshape
    batched_data = np.array(data[:nbatch * batch_size]).reshape((batch_size, nbatch)).T
    return batched_data
    ### END YOUR SOLUTION
...
def get_batch(batches, i, bptt, device=None, dtype=None):
    ...
    """
    ### BEGIN YOUR SOLUTION
    # Calculate actual sequence length (handling end of data)
